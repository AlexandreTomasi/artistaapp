...
**Caso der erro "vue-cli-service: not found" va na pasta do raiz do projeto e execute "npm install" para instalar as dependências na pasta node_modules local**  
